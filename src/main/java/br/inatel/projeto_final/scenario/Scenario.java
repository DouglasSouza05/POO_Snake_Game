package br.inatel.projeto_final.scenario;

import br.inatel.projeto_final.Arquivo;
import br.inatel.projeto_final.play_button.PlayButton;
...
import br.inatel.projeto_final.key_event_loop.KeyEventLoop;
import br.inatel.projeto_final.try_again_button.TryAgainButton;
...
public class Scenario {
    ...
    public void showGameOver(KeyEventLoop keyEventLoop) {
        TryAgainButton tryAgainButton = new TryAgainButton(e -> {
            ...
            a.writeScores(scoreTotal, Config.tries); //Escrevendo o Score anterior no ArquivoPontos.txr
    ...
    //Classe Node é o pai de todos os elementos do JavaFX, sendo assim, o resto Extends de Node
