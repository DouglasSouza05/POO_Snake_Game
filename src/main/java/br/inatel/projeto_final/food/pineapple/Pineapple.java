...
public class Pineapple extends Food {
    ...
    public void setRandomPosition() {
        ...
        this.pineapple.setTranslateY(randomNumbers(Config.oneQuarterfHeightUp, Config.oneQuarterfHeightDown - Config.squareSize));
    }
