package br.inatel.projeto_final.config;

//Clase criada para armazenar variaveis Static para configuração geral do jogo
public class Config {
    ...
    public static Integer tries = 0; //Usado para guardar o numero de tentativas
